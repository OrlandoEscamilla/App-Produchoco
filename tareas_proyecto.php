...
<div class="contenedor_tabla_conversacion">
  ...
  <thead>
    ...
    <?php 
    	$id_proyecto_get = $_GET['id'];
    	$sql = "SELECT * FROM tareas WHERE proyectos_id_proyectos = '$id_proyecto_get'";
    	...
    	while ($tarea = $ejecutar->fetch_assoc()) { 
			...
			<td><a href="tareas_proyecto.php?id=<?php echo $id_proyecto_get ?>&id_task=<?php echo $id_tareas; ?>"><?php echo $tarea['nombre_tarea']; ?></a></td>
